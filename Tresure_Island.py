...
if (direction == "right") or (direction == "A-z"):
    ...
    if action == "swim":
        ...
        door_selection = input(
            "You arrive at the island unharmed. There is a house with 3 doors.One red, one yellow "
            "and one blue. Which colour do you choose? \n"
        ).lower()
        if door_selection == "red" or door_selection == "blue":
